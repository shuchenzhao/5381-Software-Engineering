 ...
 * under the License.
 */
import { SupersetPluginChartCollaborationGraph } from '../src';
 ...
 */
describe('superset-plugin-chart-collaboration-graph', () => {
  it('exists', () => {
    expect(SupersetPluginChartCollaborationGraph).toBeDefined();
  });
});
