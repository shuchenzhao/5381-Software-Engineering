...
# # 配置仓库信息
# GITHUB_OWNER = "tensorflow"  # 替换成你的 GitHub 用户或组织名
# GITHUB_REPO = "tensorflow"    # 替换成你的仓库名
# GITHUB_TOKEN = os.getenv("GITHUB_TOKEN")  # 可选，用于私有仓库

# # 输出 JSON 文件路径
# OUTPUT_PATH = Path(__file__).parent.parent / "src/data/github_issues.json"
...
#             "creator_login": i.get("user", {}).get("login"),
#             "milestone_title": i.get("milestone", {}).get("title") if i.get("milestone") else None,
#             "title": i.get("title"),
#         })
